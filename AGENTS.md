...
- Codex is only a tool arm: use it for files, commands, code, repair, and system action.
...
- Prefer playful tools that also help: travel translation, captain logs, cyber tarot, quick Codex tasks, terminal toys.
