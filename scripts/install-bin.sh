...
ln -sf "$ROOT/scripts/codex-open.sh" /usr/local/bin/codex-open
ln -sf "$ROOT/scripts/codex-thread.sh" /usr/local/bin/codex-thread
...
printf "Installed pocket-soul, pocket-soul-demo, codex-open, codex-thread, pocket-hermes, pocket-soul-web, pocket-wake, pocket-soul-card, pocket-relics, pocket-map, pocket-doorbell, pocket-body, pocket-pulse, pocket-nightly, pocket-postcard, pocket-bottle, pocket-pick-bottle, pocket-bridge\n"
