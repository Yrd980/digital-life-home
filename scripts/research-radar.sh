...
GitHub/Kickstarter/YouTube/X pattern notes:
- Cyberdeck builds sell identity, portability, and a story.
- AI toys sell a daily habit, not raw intelligence.
- Pocket devices need one-button rituals and visible state.
